        ...
        while True:
            ...
            if masks.size != 0:
                if has_init_pose:
                    ...
                    old_cloud = pplane_ICP.depth_to_pointcloud(obj_depth, cam_K)
                    ...
                    while is_tracked:
                        ...
                        try:
                            dH = pplane_ICP.sim_icp(X_fix=old_cloud, X_mov=new_cloud,
                        ...
                        H = (dH @ H_old)
                        R = H[0:3,0:3][None,...]; t = H[0:3,-1][None,None,...]
                        new_cloud = (dH[0:3,0:3].to(torch.float32) @ new_cloud.T + dH[0:3,3][...,None].to(torch.float32)).T
