...
#ICP_max_iterations = 5    # max iterations for ICP
#ICP_correspondences = 500  # the number of points selected for iteration
ICP_max_iterations = 1    # max iterations for ICP
ICP_correspondences = 100  # the number of points selected for iteration
